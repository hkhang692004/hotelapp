...
from apps.bookings.models import Booking, BookingRoom, BookingStatus
from apps.housekeeping.models import HousekeepingTask, TaskPriority, TaskStatus, TaskType
